...
namespace XMLParsing.TSXML
{
    internal static class Renderers
    {
        internal static WF.Control Render(this XSD.Control control, FlowLayoutPanel panel) => control switch
        {
        ...
        internal static WF.Label Render(this XSD.Label label, FlowLayoutPanel panel)
        {
            WF.Label lbl = new()
            {
                Text = label.Prompt
